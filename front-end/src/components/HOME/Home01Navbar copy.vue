  ...
  <div class='flex-container'>
    <div v-if='login_modal==true && isLogin==false' class='logindirect'>
      ...
      <div class="main">
        ...
        <div>
          <img src="../../assets/NAV_LOGO.png" alt="LOGO" class='login-img mb-40'>
        </div>
        ...
        <router-link :to="{ name: 'SignUpView' }" class="no-underline">
          <button id="login" class="account">회원가입</button>
        </router-link>
          </div>
        </form>
      </div>
    ...
    <div v-if='mypage_modal==true' class='logindirect'>
      <div class="main">
        ...
        <div>
          <button id="signup" class="account" @click="logout">로그아웃</button>
        </div>
      </div>
    </div>
